...
const DailyClassTimetable = () => {
  ...
  const [selectedClassFilter, setSelectedClassFilter] = useState("Grade 10 A") // Default to a specific class
  ...
  const classesList = [
    ...
    "Grade 12 B",
    "Grade 12 C",
    "All Grades", // Added for completeness, though typically a daily view is for one class
  ]

  // Sample daily class timetable data (focused on a student's view)
  const fullTimetableData = [
    ...
    // Add more data for other classes and days as needed
    {
      id: 14,
      day: "Monday",
      time: "09:00 AM - 10:00 AM",
  ...
  const filterTimetable = (data, day, classFilter) => {
    ...
    // Sort by time for a chronological view
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.filterButtonContainer}>
          ...
          {(selectedDay !== "Monday" || selectedClassFilter !== "Grade 10 A") && ( // Adjusted default values for clear filters
            <TouchableOpacity
              style={styles.clearFiltersButton}
              onPress={() => {
                setSelectedDay("Monday") // Reset to default day
                setSelectedClassFilter("Grade 10 A") // Reset to default class
              }}
            >
            ...
            ListEmptyComponent={() => (
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptyText} allowFontScaling={false}>
                  No classes match your selected filters for this day.
                </Text>
              </View>
            )}
          />
...
const styles = StyleSheet.create({
  ...
  // Modal Styles (reused from TeacherTimetable.jsx)
  modalContainer: {
    flex: 1,
    backgroundColor: "#ffffff",
  },
